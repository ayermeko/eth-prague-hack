...
export const configSchema = z
  .object({
    ...
    X_SCRAPER_ACTOR_ID: z.string().optional(),
    METASLEUTH_DEEP_ACTOR_ID: z.string().optional(),
    GOPLUS_BASE_URL: z.string().url().optional(),
    SCAMSNIFFER_URL: z.string().url().optional(),
    GOPLUS_CHAIN_ID: z.coerce.number().optional(),
